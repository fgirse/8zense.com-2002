  ...
  return (
    <header className="flex flex-col w-full lg:h-20 text-white items-center justify-between bg-transparent">
      <div id="" className="bg-neutral-600 w-[100vw] h-20 flex flex-row items-center justify-between ">
        ...
        <SignedIn>
          <nav className=" hidden lg:flex lg:flex-row lg:items-baseline lg:max-w-6xl">
            <NavItems />
          ...
          <SignedOut>
             ...
             <div className='w-full flex flex-row justify-end items-baseline gap-x-3'>
               ...
               <div className="w-12 h-12 lg:w-8 lg:h-8">
                <Image src={Locked} alt="Schloss" sizes="100vw"   className='relative rounded-full border-0 -8 border-gray-300'/>
                </div>
