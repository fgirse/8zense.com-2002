...
<div className="px-3 py-3 min-h-screen grid grid-cols-12 grid-rows-16 gap-2">
      ...
      <h1 className=" px-1 uppercase text-[2.10rem] font-black sm:text-8xl md:text-8xl bg-gradient-to-b from-zinc-500 to-zinc-200 bg-clip-text text-transparent lg:text-[11.66rem] lg:tracking-widest lg:mb-3">Timeless</h1>


<h1 className="relative px-1 -top-4 uppercase text-[2.97rem] font-black md:text-[9.11rem] bg-gradient-to-b from-cyan-700 via bg-yellow-500 to-zinc-300 bg-clip-text text-transparent lg:-top-28 lg:text-[12rem] lg:tracking-wider">Design</h1>
