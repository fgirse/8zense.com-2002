  ...
  return (
   ...
   <div className=" bg-zinc-200 grid grid-cols-12 grid-rows-16 gap-1">
    <div className="bg-[#66696b] col-span-12 row-span-2">
             <h1 className=" text-xl font-bold text-white text-center md:text-3xl lg:py-5">About</h1> 
    </div>
    ...
    <h1   className='relative  text-center text-3xl text-white uppercase'>projekt sao paulo-brasil</h1>
      </div>
    <div className="bg-black col-span-2 row-span-4 col-start-11 row-start-3">
          <h1 className="w-60 md:mt-24 leading-5 transform -rotate-90 text-white text-[1rem]">Conquet Projer:  Hotel in Sao Paulo</h1>
    </div>
    ...
    <div className="col-span-7 row-span-2 row-start-15 bg-zenseGrey">
      ...
      <p className="m text-[.866rem] text-white text-justify  px-4 py-3">
    ...
    <div className="col-span-5 row-span-2 col-start-8 row-start-15 bg-zenseSignal/20">
    <h1 className="bg-zenseGrey leading-7 mt-12 font-black px-1 text-[2.11rem] uppercase headingA" >education projekte</h1 >
    <div className='w-60 h-60'>
      <Image className='object-fit' src={Grafik}  alt='grafik'  />          
