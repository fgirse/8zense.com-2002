...
const Contact = () => {
  return (
    ...
    <h1  className='mt-2 bg-zenseGrey/50 w-36 mx-auto text-center uppercase font-black text-xl text-zenseGray' >contact</h1>
...
<div className="grid md:grid-cols-2 md:grid-rows-2 md:first-letter:gap-2 items-centers">
    ...
    <h1 className='mt-20 text-center text-2xl font-semibold text-zenseSignal md:mt-52'>María Fernanda Pereira Campos</h1>
